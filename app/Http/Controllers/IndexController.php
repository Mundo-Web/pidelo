...
class IndexController extends Controller
{
  ...
  public function index()
  {
    ...
    $banners = Banners::where('status',  1)->where('visible',  1)->get();
    ...
    $descuentos = Products::where('products.descuento', '>', 0)->where('products.status', '=', 1)
      ->where('visible', '=', 1)->with('tags')->get()->take(8);
    ...
    return view('public.index', compact('logos','url_env', 'popups', 'banners', 'blogs', 'categoriasAll', 'productosPupulares', 'ultimosProductos', 'productos', 'destacados', 'descuentos', 'general', 'benefit', 'faqs', 'testimonie', 'slider', 'categorias', 'category'));
  }
