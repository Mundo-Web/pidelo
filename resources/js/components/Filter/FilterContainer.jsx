...
const FilterContainer = ({ minPrice, setFilter, filter, maxPrice, categories = [], tags = [], brands = [], sizes = [], colors = [], attribute_values, tag_id, selected_category }) => {
  ...
  return (<>
    {/* <button className="w-full h-12 text-[17px] bg-[#006BF6] text-white text-center font-mulish_SemiBold  rounded-full" type="reset">
      Limpiar filtros
    </button> */}
    ...
    </FilterItem>
    {
      categories.length > 0 && (
        ...
        <div className="w-full ">
          <h2 className="font-mulish_SemiBold mb-4">Categorias</h2>
    ...
    }
    {
      tags.length > 0 && <div className="flex flex-col gap-4 w-full">
        <h2 className="font-mulish_SemiBold">Etiquetas</h2>
