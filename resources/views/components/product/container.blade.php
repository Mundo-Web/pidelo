<div class="flex flex-col flex-1 shrink basis-0 min-w-[240px]">
  <div class="flex flex-col w-full rounded-none">
    <div class="flex flex-col justify-center  content-center  rounded-xl text-center bg-neutral-100 max-md:px-5">
      <img loading="lazy" src="{{ asset($item->imagen) }}" class="object-contain aspect-square  text-center" />
    </div>
  </div>
  <div class="flex flex-col mt-6 w-full">
    <div class="flex flex-col w-full">
      <div class="text-base font-medium text-zinc-950">{{ $item->category->name }}</div>
